...
# Game logic.
guessed_letters = []
TOTAL_NUM_OF_INCORRECT_GUESSED_ALLOWED = 5
num_of_incorrect_guesses = 0

while num_of_incorrect_guesses < TOTAL_NUM_OF_INCORRECT_GUESSED_ALLOWED and False in answer_guessed:
...
print(f"Number of incorrect guesses remaining: {TOTAL_NUM_OF_INCORRECT_GUESSED_ALLOWED - num_of_incorrect_guesses}")
...
#Post-game summary
if num_of_incorrect_guesses < TOTAL_NUM_OF_INCORRECT_GUESSED_ALLOWED:
